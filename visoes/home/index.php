        ...
        <div id="homeCarousel" class="carousel slide hidden-xs hidden-sm" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?php echo(IMGPRODUTOS_ABSPATH); ?>/xbox.jpg" alt="Primeiro slide">
                    <div class="container">
                ...
                <div class="item">
                    <img src="<?php echo(IMGPRODUTOS_ABSPATH); ?>/mario.jpg" alt="Segundo slide">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Mario Kart 8.</h1>
                        </div>
                ...
                <div class="item">
                    <img src="<?php echo(IMGPRODUTOS_ABSPATH); ?>/csgo.jpg" alt="Terceiro slide">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Populares.</h1>
                        </div>
