                    ...
                    <div class="col-xs-12 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption center">
                                <p><b><?php echo ($produto->getTitulo()); ?></b></p>
                                ...
                                <?php } else { ?>
                                    <p><small>Valor:R$ <?php echo (moeda($produto->getValor())); ?></small></p>
                                <?php } ?>
                                <p>
                                    <a href="?controle=carrinho&acao=incluir&idProduto=<?php echo ($produto->getIdProduto()); ?>" class="btn btn-danger" role="button">
