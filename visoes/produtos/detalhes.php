        ...
        foreach ($objProdutos as $produto) {
            ...
            <div class="row">
                <div class="col-xs-8 col-md-push-4">
                    <div class="thumbnailimageajust">
                        <div class="thumbnailimage"><a href="/">
                ...
                <div class="col-xs-3 col-md-pull-7">
                    <h1 class="titulosombra"><?php echo $produto->getTitulo(); ?></h1>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo $produto->getLan(); ?></td>
                        </tr>
                        <tr>
                            <th>Plataformas disponíveis</th>
                            <td><?php echo $produto->getPlat(); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>Avaliação da crítica</th>
                            <td><?php echo $produto->getNota(); ?></td>
                        </tr>-->
